            ...
            <section class="vbox">
                <section class="scrollable padder">
                    ...
                    <section class="row m-b-md">
                        <div class="col-sm-6">
                            <h3 class="m-b-xs text-black">Dashboard</h3> <small>Welcome back, <?php echo $_SESSION['name']; ?>, <i class="fa fa-envelope" aria-hidden="true"></i> <?php echo $_SESSION['email']; ?></small> </div>
